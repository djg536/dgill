            ...
            <div>
                <div class='main-text'>
                    ...
                    <div class='embed-responsive embed-responsive-16by9'>
                        <iframe class='embed-responsive-item' src='https://www.youtube.com/embed/_e7IRnpuBSE' allowFullScreen title='A YouTube video of a ride on a Class 91 going north towards York'></iframe>
                    </div>
                    ...
                    <br/>
                    <img class='img-fluid' src={require('../../assets/trains/91/1.jpg')} alt={caption1}/>
                    <br/>
                    <br/>
                    <strong>Below: {caption2}</strong>
                    <br/>
                    <img class='img-fluid' src={require('../../assets/trains/91/2.jpg')} alt={caption2}/>
                    <br/>
                    <br/>
                    <strong>Below: {caption3}</strong>
                    <br/>
                    <img class='img-fluid' src={require('../../assets/trains/91/3.jpg')} alt={caption3}/>
                </div>
            </div>
        );
    }
