            ...
            <div>
                <div class='main-text'>
                    ...
                    <div class='embed-responsive embed-responsive-16by9'>
                        <iframe class='embed-responsive-item' src='https://www.youtube.com/embed/BG5PsQF0Ki8' allowFullScreen title='A video of Class 315s on the Shenfield to London stopper service, including a couple of rides'></iframe>
                    </div>	
                    ...
                    <br/>
                    <img class='img-fluid' src={require('../../assets/trains/315/1.jpg')} alt={caption1} />
                    <br/>
                    <br/>
                    <strong>Below: {caption2}</strong>
                    <br/>
                    <img class='img-fluid' src={require('../../assets/trains/315/2.jpg')} alt={caption2} />
                </div>	
            </div>
        );
    }
