            ...
            <div>
                <div class='main-text'>
                    ...
                    <div class='embed-responsive embed-responsive-16by9'>
                        <iframe class='embed-responsive-item' src='https://www.youtube.com/embed/tXkXQ7FoNc8' allowFullScreen title='A YouTube video taken on a HST at speed out of an open window on one of its slam doors'></iframe>
                    </div>
                    ...
                    <br/>
                    <img class='img-fluid' src={require('../../assets/trains/43/1.jpg')} alt={caption1}/>
                    <br/>
                    <br/>
                    <strong>Below: {caption2}</strong>
                    <br/>
                    <img class='img-fluid' src={require('../../assets/trains/43/2.jpg')} alt={caption2}/>
                    <br/>
                    <br/>
                    <strong>Below: {caption3}</strong>
                    <br/>
                    <img class='img-fluid' src={require('../../assets/trains/43/3.jpg')} alt={caption3}/>
                </div>
            </div>
        );
    }
