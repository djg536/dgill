            ...
            <div>
                <div className='main-text'>
                    ...
                    <div className='embed-responsive embed-responsive-16by9'>
                        <iframe className='embed-responsive-item' src='https://www.youtube.com/embed/peU39OUh614' allowFullScreen title='YouTube video of a ride on a Class 317 leaving Cambridge for London via the West Anglia Main Line'></iframe>
                    </div>
                    ...
                    <br/>
                    <img className='img-fluid' src={require('../../assets/trains/317/1.jpg')} alt={caption1} />
                    <br/>
                    <br/>
                    <strong>Below: {caption2}</strong>
                    <br/>
                    <img className='img-fluid' src={require('../../assets/trains/317/2.jpg')} alt={caption2} />
                </div>
            </div>
        );
    }
