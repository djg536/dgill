            ...
            <div>
                <div class="main-text">
                    ...
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/peU39OUh614" allowFullScreen></iframe>
                    </div>

                    <br/>
                    <br/>
                    <strong>Below: Greater Anglia Class 317/6 Interior, refurbished around the new millennium, which I think is quite comfortable.</strong>
                    <br/>
                    <img class="img-fluid" src={require("../../assets/trains/317/1.jpg")} />
                    <br/>
                    <br/>
                    <strong>Below: Greater Anglia Class 317/5 Interior, which I think have some of the worst seats of any train in the UK; the originals from the 1980s with just different seat covers - they are falling apart! However, they are miles better than they were with the old seat covers and carpets which made these trains smell like a wet dog.
                    </strong>
                    <br/>
                    <img class="img-fluid" src={require("../../assets/trains/317/2.jpg")} />
                </div>
            </div>
        );
    }
